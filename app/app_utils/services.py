...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-1b134bc81ede")
    loc = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION") or os.environ.get("GOOGLE_CLOUD_LOCATION")
    if not loc or loc == "global":
        loc = "us-east4"
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "3705200253977231360")
